...
export const PHASE_BOSS_TEMPLATES: Partial<Record<PhaseBossSlug, PhaseSectionTpl[]>> = {
  ...
  council: [
    ...
    { key: "magickicks", title: "Magic Kicks", subtitle: "Malande",
      slots: [
        { label: "Kick 1", specs: ["Arcane Mage", "Fire Mage", "Frost Mage", "Elemental Shaman", "Restoration Shaman"], tiered: true, nth: 1 },
        { label: "Kick 2", specs: ["Arcane Mage", "Fire Mage", "Frost Mage", "Elemental Shaman", "Restoration Shaman"], tiered: true, nth: 2 },
        { label: "Kick 3", specs: ["Arcane Mage", "Fire Mage", "Frost Mage", "Elemental Shaman", "Restoration Shaman"], tiered: true, nth: 3 },
        { label: "Kick 4", specs: ["Arcane Mage", "Fire Mage", "Frost Mage", "Elemental Shaman", "Restoration Shaman"], tiered: true, nth: 4 },
      ] },
