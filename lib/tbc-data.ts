...
const karazhan: RaidDef = {
  ...
  bosses: [
    ...
    { name: "Netherspite", items: [
      ...
      { name: "Leggings of the Fallen Defender", wowheadId: 29763, slot: "Token (Legs)", itemLevel: 120, archetype: "token-protector" },
      { name: "Leggings of the Fallen Hero", wowheadId: 29764, slot: "Token (Legs)", itemLevel: 120, archetype: "token-vanquisher" },
      { name: "Pillar of Ferocity", wowheadId: 28824, slot: "Polearm", itemLevel: 115, archetype: "weapon-polearm" },
      { name: "Collar of Cho'gall", wowheadId: 28826, slot: "Neck", itemLevel: 115, archetype: "jewel-caster" },
...
const magtheridonsLair: RaidDef = {
  ...
  bosses: [
    { name: "Magtheridon", items: [
      ...
      { name: "Glaive of the Pit", wowheadId: 28799, slot: "Two-Hand Sword", itemLevel: 128, archetype: "weapon-2h-melee" },
...
const ssc: RaidDef = {
  ...
  bosses: [
    { name: "Hydross the Unstable", items: [
      t5Gloves("Gloves of the Vanquished Champion", "conqueror"),
      t5Gloves("Gloves of the Vanquished Defender", "protector"),
      t5Gloves("Gloves of the Vanquished Hero", "vanquisher"),
      { name: "Fathomstone", wowheadId: 30029, slot: "Trinket", itemLevel: 133, archetype: "trinket-caster" },
      { name: "Hydross-Encrusted Greaves", wowheadId: 30019, slot: "Feet", itemLevel: 133, archetype: "tank-plate" },
      { name: "Hydrospawn Boots", wowheadId: 30021, slot: "Feet", itemLevel: 133, archetype: "heal-mail" },
      { name: "Leggings of the Seventh Circle", wowheadId: 30022, slot: "Legs", itemLevel: 133, archetype: "heal-cloth" },
      { name: "Ring of Lethality", wowheadId: 30052, slot: "Finger", itemLevel: 133, archetype: "jewel-melee" },
      { name: "Pendant of the Perilous", wowheadId: 30017, slot: "Neck", itemLevel: 133, archetype: "jewel-tank" },
    ]},
    { name: "The Lurker Below", items: [
      t5Legs("Leggings of the Vanquished Champion", "conqueror"),
      t5Legs("Leggings of the Vanquished Defender", "protector"),
      t5Legs("Leggings of the Vanquished Hero", "vanquisher"),
      { name: "The Seal of Danzalar", wowheadId: 30107, slot: "Finger", itemLevel: 133, archetype: "jewel-tank" },
      { name: "Glowing Breastplate of Truth", wowheadId: 30099, slot: "Chest", itemLevel: 133, archetype: "heal-plate" },
      { name: "Fang of the Leviathan", wowheadId: 30088, slot: "One-Hand Sword", itemLevel: 133, archetype: "weapon-1h-melee" },
      { name: "Earring of Soulful Meditation", wowheadId: 30109, slot: "Neck", itemLevel: 133, archetype: "jewel-heal" },
      { name: "Choker of Animalistic Fury", wowheadId: 30110, slot: "Neck", itemLevel: 133, archetype: "jewel-melee" },
      { name: "Boots of the Shifting Nightmare", wowheadId: 30105, slot: "Feet", itemLevel: 133, archetype: "heal-leather" },
    ]},
    { name: "Leotheras the Blind", items: [
      t5Gloves("Gloves of the Vanquished Champion", "conqueror"),
      t5Gloves("Gloves of the Vanquished Defender", "protector"),
      t5Gloves("Gloves of the Vanquished Hero", "vanquisher"),
      { name: "Fang of Vashj", wowheadId: 30872, slot: "Dagger", itemLevel: 133, archetype: "weapon-dagger-dps" },
      { name: "Leggings of Divine Retribution", wowheadId: 30124, slot: "Legs", itemLevel: 133, archetype: "melee-plate" },
      { name: "Bands of Indwelling", wowheadId: 30116, slot: "Wrist", itemLevel: 133, archetype: "heal-cloth" },
      { name: "Belt of One-Hundred Deaths", wowheadId: 30125, slot: "Waist", itemLevel: 133, archetype: "melee-leather" },
      { name: "Scaled Greaves of the Marksman", wowheadId: 30122, slot: "Legs", itemLevel: 133, archetype: "ranged-hunter" },
      { name: "Cowl of the Grand Engineer", wowheadId: 30113, slot: "Head", itemLevel: 133, archetype: "caster-cloth" },
    ]},
    { name: "Fathom-Lord Karathress", items: [
      t5Helm("Helm of the Vanquished Champion", "conqueror"),
      t5Helm("Helm of the Vanquished Defender", "protector"),
      t5Helm("Helm of the Vanquished Hero", "vanquisher"),
      { name: "Might of the Ocean Serpent", wowheadId: 30069, slot: "Two-Hand Mace", itemLevel: 133, archetype: "weapon-2h-str" },
      { name: "Serpent-Coil Braid", wowheadId: 30675, slot: "Trinket", itemLevel: 133, archetype: "trinket-heal" },
      { name: "World Breaker", wowheadId: 30706, slot: "Two-Hand Sword", itemLevel: 133, archetype: "weapon-2h-melee" },
      { name: "Boots of Effortless Striking", wowheadId: 30542, slot: "Feet", itemLevel: 133, archetype: "melee-leather" },
      { name: "Fathom-Helm of the Deeps", wowheadId: 30669, slot: "Head", itemLevel: 133, archetype: "melee-mail" },
      { name: "Mantle of the Corrupted", wowheadId: 30676, slot: "Shoulders", itemLevel: 133, archetype: "caster-cloth" },
    ]},
    { name: "Morogrim Tidewalker", items: [
      t5Chest("Chestguard of the Vanquished Champion", "conqueror"),
      t5Chest("Chestguard of the Vanquished Defender", "protector"),
      t5Chest("Chestguard of the Vanquished Hero", "vanquisher"),
      { name: "Boots of the Colossus", wowheadId: 30666, slot: "Feet", itemLevel: 133, archetype: "tank-plate" },
      { name: "Earthsoul Britches", wowheadId: 30664, slot: "Legs", itemLevel: 133, archetype: "caster-mail" },
      { name: "Tide-Stomper's Greaves", wowheadId: 30665, slot: "Feet", itemLevel: 133, archetype: "melee-mail" },
      { name: "Runetotem's Mantle", wowheadId: 30667, slot: "Shoulders", itemLevel: 133, archetype: "heal-leather" },
      { name: "Glimmering Naaru Sliver", wowheadId: 30663, slot: "Trinket", itemLevel: 133, archetype: "trinket-heal" },
      { name: "Grethok's Control Staff", wowheadId: 30668, slot: "Staff", itemLevel: 133, archetype: "weapon-staff-caster" },
    ]},
    { name: "Lady Vashj", items: [
      t5Chest("Chestguard of the Vanquished Champion", "conqueror"),
      t5Chest("Chestguard of the Vanquished Defender", "protector"),
      t5Chest("Chestguard of the Vanquished Hero", "vanquisher"),
      { name: "Vashj's Vial Remnant", wowheadId: 33829, slot: "Trinket", itemLevel: 141, archetype: "trinket-caster" },
      { name: "Ring of Rampant Elements", wowheadId: 30667, slot: "Finger", itemLevel: 141, archetype: "jewel-caster" },
      { name: "Glorious Gauntlets of Crestfall", wowheadId: 30671, slot: "Hands", itemLevel: 141, archetype: "tank-plate" },
      { name: "Grip of Mannoroth", wowheadId: 30672, slot: "Hands", itemLevel: 141, archetype: "melee-plate" },
      { name: "Serpent Spine Longbow", wowheadId: 30905, slot: "Bow", itemLevel: 141, archetype: "weapon-bow" },
      { name: "Cord of Screaming Terrors", wowheadId: 30920, slot: "Waist", itemLevel: 141, archetype: "caster-cloth" },
      { name: "Prism of Inner Calm", wowheadId: 30926, slot: "Trinket", itemLevel: 141, archetype: "trinket-heal" },
      { name: "Illidari Runeshield", wowheadId: 30921, slot: "Shield", itemLevel: 141, archetype: "weapon-shield-tank" },
      { name: "Vestments of the Sea-Witch", wowheadId: 30908, slot: "Chest", itemLevel: 141, archetype: "caster-cloth" },
      { name: "Valanos' Longbow", wowheadId: 30915, slot: "Bow", itemLevel: 141, archetype: "weapon-bow" },
    ]},
  ],
};
...
const tempestKeep: RaidDef = {
  ...
  bosses: [
    { name: "Void Reaver", items: [
      t5Shoulder("Pauldrons of the Vanquished Champion", "conqueror"),
      t5Shoulder("Pauldrons of the Vanquished Defender", "protector"),
      t5Shoulder("Pauldrons of the Vanquished Hero", "vanquisher"),
      { name: "Void Reaver Greaves", wowheadId: 30058, slot: "Legs", itemLevel: 133, archetype: "tank-plate" },
      { name: "Girdle of Zaetar", wowheadId: 30059, slot: "Waist", itemLevel: 133, archetype: "caster-leather" },
      { name: "Elunite Forged Breastplate", wowheadId: 30057, slot: "Chest", itemLevel: 133, archetype: "melee-plate" },
      { name: "Archivist Cape", wowheadId: 30060, slot: "Back", itemLevel: 133, archetype: "cloak-heal" },
      { name: "Pauldrons of Blasting", wowheadId: 30061, slot: "Shoulders", itemLevel: 133, archetype: "caster-mail" },
      { name: "Void-Touched Leather Leggings", wowheadId: 30062, slot: "Legs", itemLevel: 133, archetype: "melee-leather" },
    ]},
    { name: "High Astromancer Solarian", items: [
      t5Shoulder("Pauldrons of the Vanquished Champion", "conqueror"),
      t5Shoulder("Pauldrons of the Vanquished Defender", "protector"),
      t5Shoulder("Pauldrons of the Vanquished Hero", "vanquisher"),
      { name: "Ring of Recurrence", wowheadId: 30002, slot: "Finger", itemLevel: 133, archetype: "jewel-heal" },
      { name: "Ring of Captured Storms", wowheadId: 30003, slot: "Finger", itemLevel: 133, archetype: "jewel-caster" },
      { name: "Shining Bauble of the Naaru", wowheadId: 30007, slot: "Trinket", itemLevel: 133, archetype: "trinket-caster" },
      { name: "Starfire Bindings", wowheadId: 30005, slot: "Wrist", itemLevel: 133, archetype: "caster-leather" },
      { name: "Worldfire Chestguard", wowheadId: 30006, slot: "Chest", itemLevel: 133, archetype: "caster-cloth" },
    ...
    { name: "Al'ar", items: [
      ...
      t5Legs("Leggings of the Vanquished Defender", "protector"),
      t5Legs("Leggings of the Vanquished Hero", "vanquisher"),
      { name: "Band of Al'ar", wowheadId: 30050, slot: "Finger", itemLevel: 133, archetype: "jewel-caster" },
      { name: "Claw of the Phoenix", wowheadId: 30051, slot: "Dagger", itemLevel: 133, archetype: "weapon-dagger-dps" },
      { name: "Phoenix-Ring of Rebirth", wowheadId: 30052, slot: "Finger", itemLevel: 133, archetype: "jewel-heal" },
      { name: "Talon of Al'ar", wowheadId: 30053, slot: "Dagger", itemLevel: 133, archetype: "weapon-dagger-caster" },
      { name: "Arcanite Steam-Pistol", wowheadId: 30054, slot: "Gun", itemLevel: 133, archetype: "weapon-gun" },
      { name: "Girdle of the Righteous Path", wowheadId: 30055, slot: "Waist", itemLevel: 133, archetype: "heal-plate" },
    ]},
    { name: "Kael'thas Sunstrider", items: [
      t5Helm("Helm of the Vanquished Champion", "conqueror"),
      t5Helm("Helm of the Vanquished Defender", "protector"),
      t5Helm("Helm of the Vanquished Hero", "vanquisher"),
      { name: "The Nexus Key", wowheadId: 30316, slot: "Staff", itemLevel: 141, archetype: "weapon-staff-caster" },
      { name: "Cosmic Infuser", wowheadId: 30317, slot: "One-Hand Mace", itemLevel: 141, archetype: "weapon-mace-heal" },
      { name: "Infinity Blade", wowheadId: 30318, slot: "One-Hand Sword", itemLevel: 141, archetype: "weapon-1h-melee" },
      { name: "Warp Slicer", wowheadId: 30319, slot: "One-Hand Sword", itemLevel: 141, archetype: "weapon-1h-melee" },
      { name: "Staff of Disintegration", wowheadId: 30320, slot: "Staff", itemLevel: 141, archetype: "weapon-staff-caster" },
      { name: "Phaseshift Bulwark", wowheadId: 30321, slot: "Shield", itemLevel: 141, archetype: "weapon-shield-tank" },
      { name: "Devastation", wowheadId: 30322, slot: "Two-Hand Axe", itemLevel: 141, archetype: "weapon-2h-melee" },
      { name: "Netherbane", wowheadId: 30323, slot: "Fist Weapon", itemLevel: 141, archetype: "weapon-fist-melee" },
      { name: "Ashes of Al'ar", wowheadId: 32458, slot: "Mount", itemLevel: 1, notes: "Flying mount — extremely rare", weights: {} },
      { name: "Ashkandi, Greatsword of the Brotherhood", wowheadId: 17182, slot: "Two-Hand Sword", itemLevel: 141, archetype: "weapon-2h-str", notes: "Nexus-King skeletal analog" },
      { name: "Crown of the Sun", wowheadId: 30909, slot: "Head", itemLevel: 141, archetype: "caster-cloth" },
      { name: "Sunhawk Leggings", wowheadId: 30912, slot: "Legs", itemLevel: 141, archetype: "melee-mail" },
    ]},
  ],
};
...
const blackTemple: RaidDef = {
  ...
  bosses: [
    ...
    { name: "Reliquary of Souls", items: [
      ...
      { name: "Bladespire Warbands", wowheadId: 32290, slot: "Wrist", itemLevel: 141, archetype: "melee-plate" },
...
const sunwell: RaidDef = {
  ...
  bosses: [
    ...
    { name: "Kil'jaeden", items: [
      ...
      { name: "Cloak of the Pit Stalker", wowheadId: 34242, slot: "Back", itemLevel: 164, archetype: "cloak-melee" },
