...
const MISSING_ITEMS: MissingItem[] = [
  ...
  { name: "Aegis of the Vindicator",   boss: "High King Maulgar",      slot: "Shield",   itemLevel: 128 },
  { name: "Liar's Tongue Gloves",      boss: "High King Maulgar",      slot: "Hands",    itemLevel: 128 },
  { name: "Hammer of the Naaru",       boss: "High King Maulgar",      slot: "One-Hand Mace", itemLevel: 128 },
  { name: "Windshear Boots",           boss: "High King Maulgar",      slot: "Feet",     itemLevel: 128 },
  // Gruul the Dragonkiller
  { name: "Eye of Gruul",              boss: "Gruul the Dragonkiller", slot: "Trinket",  itemLevel: 128 },
  // Magtheridon
  { name: "Magtheridon's Head",        boss: "Magtheridon",            slot: "Head",     itemLevel: 128 },
  { name: "Eredar Wand of Obliteration", boss: "Magtheridon",          slot: "Wand",     itemLevel: 128 },
  { name: "Karaborian Talisman",       boss: "Magtheridon",            slot: "Neck",     itemLevel: 128 },
  ...
  // Karazhan
  { name: "Belt of Divine Inspiration", boss: "The Curator",           slot: "Waist",    itemLevel: 115 },
  { name: "Gauntlets of the Dragonslayer", boss: "Nightbane",          slot: "Hands",    itemLevel: 115 },
];
