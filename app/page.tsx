    ...
    <div className="space-y-12 animate-fade-in">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { href: "/overview",   title: "Overview",     blurb: "Who's looted what, sorted by most recent.",   iconName: "inv_misc_lockbox_5",                accent: "vermillion" as const },
            { href: "/loot",       title: "Loot catalog", blurb: "Every raid drop, browsable by phase / boss.", iconName: "inv_misc_book_07",                  accent: "gold"       as const },
            ...
            { href: "/characters", title: "Characters",   blurb: "One row per character — class, spec, role.",  iconName: "inv_misc_head_murloc_02",           accent: "gold"       as const },
            { href: "/rosters",    title: "Roster",       blurb: "Master Roster membership and slot.",          iconName: "inv_misc_groupneedmore",            accent: "vermillion" as const },
